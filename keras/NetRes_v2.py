...
if __name__ == '__main__':
    ...
    #model_v1 = keras.applications.ResNet50(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000)
    model_v2 = ResNet50_v2(True)

    img = cv2.imread('/home/luis/Documentos/IA/keras/tiger.jpeg')
